...
function addTask(text) {
  ...
  // ERROR INTENCIONAL: La variable se declara incorrectamente
  let taskExits = taskExists; // BUG: typo - debería ser 'taskExists'
  console.error('ERROR: Variable taskExits declarada con typo - revisar en addTask()');
